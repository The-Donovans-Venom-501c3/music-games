...
import streak from "../../../assets/svg/Welcome_Character.svg";
import strike from "../../../assets/svg/Welcome_Character.svg";
import grey_circle from "../../../assets/svg/Welcome_Character.svg";

export default function StreakDialog() {
    return (
        <div className="wrapper">
            <div className="content  streak-dialog centralized">
                <img src={strike} alt="music-symbol" className="image" />
                ...
                <div className="streak-content centralized">
                    ...
                    <hr />
                    <p>
                        Successfully complete a game every day to grow your
                        streak. Skipping even for a day will reset your streak.
                        You’ll get a reward after 7-day streak!
                    </p>
                </div>
